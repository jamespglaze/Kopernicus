...
namespace Kopernicus
{
    ...
    public class ToolbarButton : MonoBehaviour
    {
        ...
        public void DrawKopernicusWindow(int windowId)
        {
            ...
            RuntimeUtility.RuntimeUtility.KopernicusConfig.EnableVisualAtmosphericExtinction = GUILayout.Toggle(RuntimeUtility.RuntimeUtility.KopernicusConfig.EnableVisualAtmosphericExtinction, "EnableVisualAtmosphericExtinction: Whether to use built-in atmospheric extinction effect of lens flares. Not recommended with systems with greater than 50 bodies.");
            RuntimeUtility.RuntimeUtility.KopernicusConfig.EnablePhysicalAtmosphericExtinction = GUILayout.Toggle(RuntimeUtility.RuntimeUtility.KopernicusConfig.EnablePhysicalAtmosphericExtinction, "EnablePhysicalAtmosphericExtinction: Whether to use built-in atmospheric extinction effect for stellar flux. Not recommended with systems with greater than 50 stars or 150 bodies.");
            RuntimeUtility.RuntimeUtility.KopernicusConfig.EnableRealisticFlux = GUILayout.Toggle(RuntimeUtility.RuntimeUtility.KopernicusConfig.EnableRealisticFlux, "EnableRealisticFlux: Whether to use 1/d^2 for flux calculations instead of the stock 1/(d - r)^2. Lower, but more physically accurate, temperatures and solar generation near stars.");
